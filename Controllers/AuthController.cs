...
using System.Text;
using HealthCareDemo.Models;
using HealthCareDemo.Models.DTOs;
using HealthCareDemo.Data;

namespace HealthCareDemo.Controllers;
...
{
    private HealthCareDemoDbContext _dbContext;
    private UserManager<IdentityUser> _userManager;

    public AuthController(HealthCareDemoDbContext context, UserManager<IdentityUser> userManager)
    {
        _dbContext = context;
